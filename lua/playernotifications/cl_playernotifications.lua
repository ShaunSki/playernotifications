...
function PlayerJoins( ply )
	...
	if SteamIDJoinConfig == true and SteamIDTeamColorConfig == true and ply:SteamID() == ( SteamIDJoin ) then return
		chat.AddText( SteamIDTagColor, SteamIDTagName, SteamIDNameColor, Name, SteamIDTextColor, SteamIDJoinText )
	elseif
	SteamIDJoinConfig == true and SteamIDTeamColorConfig == false and ply:SteamID() == ( SteamIDJoin ) then return
		chat.AddText( SteamIDTagColor, SteamIDTagName, TeamColor, Name, SteamIDTextColor, SteamIDJoinText )
	elseif 
	UserGroupConfig == true and UserGroupTeamColorConfig == true and ply:IsUserGroup( UserGroupJoin ) then return
	...
	elseif
	JoinConfig == true and TeamColorConfig == true then return
...
function PlayerLeft( ply )
	...
	elseif
	LeaveConfig == true and LeaveTeamColorConfig == false then return
